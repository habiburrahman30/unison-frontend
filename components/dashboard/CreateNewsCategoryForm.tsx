...
export default function CreateNewsCategoryForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!formData.name.trim()) {
            toast.error("News category name is required");
            return;
        }
        ...
        try {
            ...
            console.log("Creating news category with data:", categoryData);
            ...
            if (!response.ok) {
                ...
                throw new Error(result.message || "Failed to create news category");
            }
            ...
            toast.error(error.message || "Failed to create news category");
                    ...
                    <div className="col-md-12">
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                className="form-control"
                                rows={4}
                                placeholder="Enter news category description (optional)"
