...
export default function EditTeamForm({ member }: Props) {
    ...
    const isFormValid = formData.name.trim().length > 0 && formData.position.trim().length > 0;
            ...
            <form onSubmit={handleSubmit}>
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <input type="url" name="facebook" className="form-control"
                                placeholder="https://facebook.com/..." value={formData.facebook}
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            <label><i className="fab fa-twitter me-1" /> Twitter</label>
                            <input type="url" name="twitter" className="form-control"
                                placeholder="https://twitter.com/..." value={formData.twitter}
                                onChange={handleChange} disabled={isSubmitting} />
                        </div>
                    </div>
                    ...
                    <div className="col-md-6">
                        <div className="form-group">
                            ...
                            <input type="url" name="instagram" className="form-control"
                                placeholder="https://instagram.com/..." value={formData.instagram}
                                onChange={handleChange} disabled={isSubmitting} />
                        </div>
                    </div>
                    ...
                    <div className="col-md-12">
                        <div className="form-group">
                            <label>Profile Image <small className="text-muted">(Optional, max 5MB)</small></label>
                            <input
                                type="file"
                                className="form-control"
                                accept="image/*"
                ...
                <div className="row mt-4">
                    <div className="col text-start">
                        <Link href="/admin/teams" className="theme-btn" style={{ opacity: isSubmitting ? 0.5 : 1 }}>
                    ...
                    <div className="col text-end">
                        ...
                        >
                            {isSubmitting ? (
                                ...
                                <><span className="far fa-save" /> Update Member</>
                            )}
                        </button>
                    </div>
                </div>
